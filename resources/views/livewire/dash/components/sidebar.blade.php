<div id="logo-sidebar" x-show="sidebar" :class="{ 'fixed': sidebar, 'absolute': !sidebar }"
    class="sm:w-64 w-1/2 h-full top-0 left-0 pt-20 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 overflow-y-auto transition-all duration-300 ease-in-out">
